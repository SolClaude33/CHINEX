...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a14] text-[#ffe3e3] font-pixel overflow-x-hidden">
      {/* Background pattern overlay */}
      <div
        className="fixed inset-0 z-0 opacity-20 pointer-events-none"
        style={{
          backgroundImage:
            "repeating-linear-gradient(45deg, #b11500 0px, #b11500 2px, transparent 2px, transparent 16px), repeating-linear-gradient(135deg, #b11500 0px, #b11500 2px, transparent 2px, transparent 16px)",
      ...
      <div className="w-full grid grid-cols-5 relative z-10 ">
        <div className="flex flex-col gap-4 ml-2">
          ...
          <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md relative overflow-hidden">
            <h2 className="text-sm bg-gradient-to-r from-[#660000] to-[#cc0000] p-3">CHINEX — The People’s Dragon Index</h2>
        ...
        <div className="col-span-3 w-full px-2">
          ...
          <header className="mt-4 mb-6 relative">
            <div className="relative h-40 sm:h-48 md:h-56 bg-[url('/banner.png')] bg-cover bg-center rounded-md overflow-hidden">
              ...
              <div className="absolute top-2 left-2 h-8 w-8 border-t-2 border-l-2 border-[#ff9999]"></div>
              <div className="absolute top-2 right-2 h-8 w-8 border-t-2 border-r-2 border-[#ff9999]"></div>
              <div className="absolute bottom-2 left-2 h-8 w-8 border-b-2 border-l-2 border-[#ff9999]"></div>
              <div className="absolute bottom-2 right-2 h-8 w-8 border-b-2 border-r-2 border-[#ff9999]"></div>
            </div>

            {/* Marquee text below banner */}
            <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md mt-2 py-1 overflow-hidden">
              <div className="animate-marquee whitespace-nowrap">
                <span className="text-[#ff3333] mx-4">★彡 Welcome to my cyber realm! 彡★</span>
                ...
                <span className="text-[#ff99cc] mx-4">0x25805b31fbb8d8828b3761ae774610d1e9494444</span>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <aside className="w-full md:w-64 flex-shrink-0 space-y-4">
              ...
              <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md p-3 relative">
                ...
                <div className="mt-6 space-y-2">
                  {["about", "blog", "sources", "archive"].map((item) => (
                    <Button
                      key={item}
                      variant="outline"
                      className="w-full bg-[#440000] border-[#cc3333] hover:bg-[#aa0000] text-[#ff9999] justify-start group"
                    >
                      <ChevronRight className="h-4 w-4 mr-2 text-[#ff3333] group-hover:text-white" />
                ...
                <div className="absolute -bottom-3 left-0 right-0 h-3 overflow-hidden">
                  <div
                    className="w-full h-6 bg-[#cc3333]"
                    style={{
              ...
              <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md p-3 relative">
                ...
                <div className="mt-6 space-y-2 text-[11px]">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#ff3333]">690,069</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Active Nodes:</span>
                    <span className="text-[#ff3333]">1 (you) </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Sentiment:</span>
            ...
            <main className="flex-1 space-y-4">
              {/* Welcome Section */}
              <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md p-4 relative">
                <div className="absolute top-0 left-0 right-0 h-6 bg-gradient-to-r from-[#660000] to-[#cc0000] flex items-center px-2">
                ...
                <div className="mt-6 space-y-4">
                  ...
                  {/* ASCII Art Box */}
                  <div className="bg-[#440000] border border-[#cc3333] p-2 font-mono text-xs text-[#ff3333] whitespace-pre overflow-x-auto">
                    {`  /\\_/\\  
 ( o.o ) 
  > ^ <  
 Cyber Cat
 says hi!`}
 <p className="text-xl">0x25805b31fbb8d8828b3761ae774610d1e9494444</p>
                  </div>

                  <div className="flex flex-wrap gap-2 mt-4">
                    {["y2k", "cyber", "nostalgic", "pixel art", "anime"].map((tag) => (
                      <Badge key={tag} className="bg-[#aa0000] text-[#ff9999] hover:bg-[#cc0000]">
                        #{tag}
                      </Badge>
                    ))}
                  </div>
                ...
                <div className="mt-6 space-y-4">
                  {[
                    ...
                    <div key={idx} className="flex gap-2">
                      ...
                      <div className="text-[#ff9999]">{update.title}</div>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {
                    characters.map((c, i) => (
                      <div key={i} className="flex flex-col items-center">
                        <div className="w-24 h-24 bg-[#440000] border border-[#cc3333] relative">
                          <Image
              ...
              <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md p-4 relative">
                ...
                <div className="mt-6 space-y-4">
                  <div className="bg-[#440000] border border-[#cc3333] p-3 text-[#ff9999] relative">
                    ...
                    {/* Decorative corner elements */}
                    <div className="absolute top-1 left-1 h-4 w-4 border-t border-l border-[#ff9999]"></div>
                    <div className="absolute top-1 right-1 h-4 w-4 border-t border-r border-[#ff9999]"></div>
                    <div className="absolute bottom-1 left-1 h-4 w-4 border-b border-l border-[#ff9999]"></div>
                    <div className="absolute bottom-1 right-1 h-4 w-4 border-b border-r border-[#ff9999]"></div>
                  </div>
                </div>
              </div>
            </main>
            ...
            <aside className="w-full md:w-64 flex-shrink-0 space-y-4">
              ...
              <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md p-3 relative">
                ...
                <div className="mt-6 flex flex-col items-center">
                  ...
                  <div className="mt-2 text-center">
                    ...
                    <div className="text-xs text-[#ff9999]">Level 88 Market Oracle</div>
                  </div>
                  <Separator className="my-2 bg-[#cc3333]" />
                  <div className="w-full text-xs space-y-1">
                    <div className="flex justify-between">
                      <span>
                        Joined:
                      </span>
                      <span className="text-[#ff3333]">08/30/1930</span>
                    </div>
                    <div className="flex justify-between">
                      <span>
                      ...
                      <span className="text-[#ff3333]">51,000</span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-[#ff3333]">infinite ∞</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md p-3 relative">
                ...
                <div className="mt-6 space-y-2">
                  {buttons.map((ring, idx) => (
                    <div key={idx} className="bg-[#440000] border border-[#cc3333] p-2 text-center">
                      <div className="text-xs text-[#ff99cc] font-bold">{ring.text}</div>
                      <div className="flex justify-center gap-2 mt-1">
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-6 px-2 py-0 text-[#ff9999] bg-[#660000] border-[#cc3333] hover:bg-[#aa0000]"
                        >
                          {ring.prev}
                        </Button>
                        <Button
              ...
              <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md p-3 relative">
                ...
                <div className="mt-6 grid grid-cols-2 gap-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="bg-[#440000] border border-[#cc3333] p-1 flex items-center justify-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md relative overflow-hidden">
            <h2 className="text-sm bg-gradient-to-r from-[#660000] to-[#cc0000] p-3">CHINEX Envoys Interrupt PBOC Briefing with a Jade Candle NFT</h2>
            <div className="p-3 text-xs">
              <p>
          ...
          <div className="bg-[#330000] border-2 border-[#cc3333] rounded-md relative overflow-hidden">
            <h2 className="text-sm bg-gradient-to-r from-[#660000] to-[#cc0000] p-3">New Metric Shakes the Red Tide: “Qi-to-Asset Ratio”</h2>
            <div className="p-3 text-xs">
              <p>
