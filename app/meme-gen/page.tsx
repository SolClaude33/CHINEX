      ...
      <div className="relative z-10 p-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center gap-6">
            ...
            <div className="">
              <div className="bg-slate-800/80 border-2 border-[#cc3333] rounded-lg p-4">
                ...
                <div className={`${!mainImage && "border-2 border-dashed border-[#cc3333]/50 rounded-lg"} mb-4`} style={{ minHeight: '600px', }}>
                  <Stage
              ...
              <div className="bg-slate-800/80 border-2 border-[#cc3333] rounded-lg p-4">
                ...
                <div className="flex flex-row flex-wrap gap-3 mb-4">
                  <button
                    ...
                    className='w-16 h-16 bg-gray-700/30 flex justify-center items-center group border-2 border-transparent rounded-lg aria-selected:border-[#cc3333]'
                  ...
                  </button>
                  {
                    Array(5).fill(1).map((_, index) => (
                      <button
                        ...
                        className='w-16 h-16 flex justify-center items-center group rounded-lg border-2 border-transparent aria-selected:border-[#cc3333]'
